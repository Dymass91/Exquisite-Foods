    ...
    return (
        <div className="Benefits__article">
            ...
            <p>
                ...
                The fats that provide greater benefits to health are the monounsaturated fats, so they  <img className="benefitsimg" src={benefitsimg} alt="miasto" />should be consumed largely replacing other saturated (animal fats, coconut and palm oils) and polyunsaturated (seed oils).
